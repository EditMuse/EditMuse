...
const MULTILINGUAL_MAP: Record<string, string[]> = {
  // English -> All languages (merged to avoid duplicate keys)
  "perfume": ["perfume", "fragancia", "parfüm", "profumo", "perfume"],
  "fragrance": ["fragancia", "perfume"],
  "shoes": ["zapatos", "calzado", "chaussures", "schuhe", "scarpe", "sapatos", "calçados", "schoenen", "обувь", "туфли", "靴", "シューズ", "鞋子", "鞋"],
  "shirt": ["camisa", "chemise", "hemd", "camicia", "camisa", "shirt", "overhemd", "рубашка", "シャツ", "衬衫"],
  "dress": ["vestido", "robe", "kleid", "vestito", "abito", "vestido", "jurk", "платье", "ドレス", "连衣裙"],
  "pants": ["pantalones", "pantalon", "hose", "pantaloni", "calças", "broek", "брюки", "パンツ", "裤子"],
  "jacket": ["chaqueta", "saco", "veste", "blouson", "jacke", "mantel", "giacca", "jaqueta", "casaco", "jas", "куртка", "ジャケット", "夹克"],
  "bag": ["bolsa", "bolso", "mochila", "sac", "sac à main", "tasche", "beutel", "borsa", "zaino", "bolsa", "mochila", "tas", "сумка", "バッグ", "包", "袋子"],
  "watch": ["reloj", "montre", "uhr", "armbanduhr", "orologio", "relógio", "horloge", "часы", "時計", "ウォッチ", "手表"],
  "phone": ["teléfono", "celular", "téléphone", "portable", "telefon", "handy", "telefono", "cellulare", "telefone", "celular", "telefoon", "телефон", "電話", "スマホ", "手机", "电话"],
  "laptop": ["portátil", "laptop", "ordinateur portable", "laptop", "laptop", "notebook", "laptop", "portatile", "laptop", "notebook"],
  "headphones": ["auriculares", "audífonos", "écouteurs", "casque", "kopfhörer", "cuffie", "auricolari", "fones de ouvido"],
  "sofa": ["sofá", "canapé", "sofa", "sofa", "couch", "divano", "sofà", "sofá", "bank", "sofa", "диван", "ソファ", "沙发"],
  "table": ["mesa", "table", "tisch", "tavolo", "mesa", "tafel", "стол", "テーブル", "桌子"],
  "chair": ["silla", "chaise", "stuhl", "sedia", "cadeira", "stoel", "стул", "椅子", "チェア", "椅子"],
  "bed": ["cama", "lit", "bett", "letto", "cama", "bed", "кровать", "ベッド", "床"],
  "lamp": ["lámpara", "lampe", "lampe", "lampada", "lâmpada", "lamp", "лампа", "ランプ", "灯"],
  "car": ["coche", "carro", "auto", "voiture", "auto", "auto", "wagen", "auto", "macchina", "carro", "automóvel", "auto", "машина", "автомобиль", "車", "カー", "汽车", "车"],
  "bike": ["bicicleta", "bici", "vélo", "bicyclette", "fahrrad", "rad", "bicicletta", "bici", "bicicleta", "велосипед", "自転車", "自行车"],
  "gift": ["regalo", "cadeau", "geschenk", "regalo", "presente", "cadeau", "подарок", "贈り物", "ギフト", "礼物"],
  "sale": ["oferta", "rebaja", "descuento", "solde", "promotion", "angebot", "rabatt", "sconto", "offerta", "promoção", "desconto", "uitverkoop", "korting", "распродажа", "скидка", "セール", "割引", "促销", "折扣"],
